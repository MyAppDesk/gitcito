...
רשימת הקבצים נבחרת בבחירה מרובה באותן מחוות כמו ב[סטייג׳ינג](staging.md) —
לחיצה עם <kbd>⌘</kbd>/<kbd>Ctrl</kbd>, לחיצה עם <kbd>⇧</kbd>,
<kbd>⇧</kbd>+<kbd>↑</kbd>/<kbd>↓</kbd> — ולחיצה ימנית (או כפתור *החלת n קבצים*)
משחזרת רק את הבחירה.
