...
| **Майстер налаштування ШІ** | Генерує файли конфігурації асистента (інструкції, агенти, хуки) для репозиторію — кнопка з чарівною паличкою в заголовку панелі чату |
