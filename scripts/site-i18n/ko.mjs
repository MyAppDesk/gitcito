...
export const ko = {
  ...
  'feature.cli.title': '진짜 CLI를 갖춘 Git GUI',
  'feature.cli.body':
    '`gitcito .`는 저장소를 열고, `gitcito blame src/api.ts -l 84`는 해당 줄에서 엽니다. `gitcito doctor`는 창을 전혀 열지 않고 저장소의 요구 사항을 검사한 뒤 CI가 읽을 수 있는 종료 코드를 반환합니다.'
}
