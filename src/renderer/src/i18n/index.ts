...
const en = {
  ...
  'settings.aiAssistantHint': 'Ask the AI to act on the current repo, or generate config files (CI, .gitignore, agent rules…).',
  'settings.openAiAssistant': 'Open AI assistant',
...
const es: Dict = {
  ...
  'settings.aiAssistantHint': 'Pide a la IA que actúe sobre el repo actual o genera archivos de configuración (CI, .gitignore, reglas de agente…).',
  'settings.openAiAssistant': 'Abrir asistente de IA',
