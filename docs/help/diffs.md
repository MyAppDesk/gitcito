...
![Split diff with word-level highlighting](../screenshots/split-diff.png)
...
![Image diff](../screenshots/image-diff.png)
...
![The files tab with a preview](../screenshots/file-tree.png)
