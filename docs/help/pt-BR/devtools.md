...
um botão. Ao clicar, o DevTools abre **no próprio repositório**, como um dos seus
[ícones](workspaces.md) em vez de uma aba separada. Um ícone por sessão — dois
apps rodando ao mesmo tempo são dois DevTools.

Um **hot restart publica um endereço novo**, e o painel acompanha enquanto a
sessão viver. Quando a sessão acaba, o painel guarda o último endereço, que
normalmente já está morto: feche o ícone e abra o DevTools a partir da nova
execução.
