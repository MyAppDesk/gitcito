...
import { Plus, FolderGit2, X, Minus, Square, Settings, Sparkles, Bell, BarChart3, BookOpen, ScrollText, CircleDot, Flag, Tag, Download, ArrowDownToLine, KeyRound, LayoutGrid } from 'lucide-react'
