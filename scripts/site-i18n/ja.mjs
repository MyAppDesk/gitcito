...
export const ja = {
  ...
  'feature.cli.title': '本物の CLI を備えた Git GUI',
  'feature.cli.body':
    '`gitcito .` はリポジトリを開き、`gitcito blame src/api.ts -l 84` はその行で開きます。`gitcito doctor` はウィンドウをまったく開かず、リポジトリの要件を検査して CI が読める終了コードを返します。'
}
