...
מערך הפעולות זהה לזה של עוזר **הרצה** בסרגל הכלים: תבניות התעלמות, הכנה, ביטול
הכנה, קומיט, סטאש, זריקת שינויים, ענף, צ׳קאאוט, תיוג. כל מה שמעבר לכך — push,‏
pull,‏ reset,‏ rebase, פעולות בכפייה — נדחה בכוונה; הצ׳אט יפנה אתכם לממשק הייעודי
במקום.
